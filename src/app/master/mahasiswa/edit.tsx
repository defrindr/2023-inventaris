import { getLecturer, getStudent, updateLecturer, updateStudent } from "./services";
...
export default function Edit() {
  ...
  const setInitialValue = () => {
    ...
    setValue("no_identitas", student?.no_identitas);
    setValue("no_hp", student?.no_hp);
  ...
  const { mutate, isLoading } = useMutation(updateStudent, {
    onSuccess: (data) => {
      queryClient.setQueriesData(["student"], data);
      AlertSuccess("Data berhasil disimpan");
      navigate("/master/mahasiswa");
      console.log("success");
    },
    onError: (error) => {
      console.log(error);
        ...
        <Card title={"Edit Mahasiswa"}>
          <Form>
            ...
            <div className="mb-4">
              ...
              <PhotoUploader photo={student.foto} onPhotoUpload={handlePhotoUpload} />
            </div>
